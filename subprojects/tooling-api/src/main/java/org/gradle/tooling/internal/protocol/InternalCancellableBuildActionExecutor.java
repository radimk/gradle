...
/**
 * Mixed into a provider connection, to allow client-provided build actions with cancellation to be executed.
 *
 * <p>DO NOT CHANGE THIS INTERFACE - it is part of the cross-version protocol.
 *
 * <p>Consumer compatibility: This interface is used by all consumer versions from 2.0-rc-1.</p>
 * <p>Provider compatibility: This interface is implemented by all provider versions from 2.0-rc-1.</p>
 *
 * @since 2.0-rc-1
 * @see org.gradle.tooling.internal.protocol.ConnectionVersion4
 */
public interface InternalCancellableBuildActionExecutor extends InternalProtocolInterface {
    /**
