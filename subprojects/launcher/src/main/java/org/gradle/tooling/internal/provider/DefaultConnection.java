...
public class DefaultConnection implements InternalConnection, BuildActionRunner,
        ConfigurableConnection, ModelBuilder, CancellableModelBuilder,
        InternalBuildActionExecutor, InternalCancellableBuildActionExecutor {
...
//        services.close();
    ...
    /**
     * This is used by consumers 2.0-rc-1 and later
     */
